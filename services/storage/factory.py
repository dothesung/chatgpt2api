...
def create_storage_backend(data_dir: Path) -> StorageBackend:
    ...
    if backend_type == "json":
        # Lazy import để tránh lỗi hệ thống tệp cục bộ khi chạy serverless
        ...
        # Bắt buộc Lazy import GitStorageBackend vào ĐÚNG block này để ngăn 
        # Vercel nạp module 'git' (GitPython) khi đang chạy chế độ database.
